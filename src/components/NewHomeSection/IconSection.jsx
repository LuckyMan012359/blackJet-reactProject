    ...
    <div>
      <div className='social-media-wrap'>
        <Link to='/' onClick={goToTop}>
          {' '}
          <img className='brand-logo' src='/images/img_television.svg' alt='television' />
        </Link>
        <div className='social-wrap'>
          <ul>
            <li>
              ...
              >
                <img src='/images/img_socialiconfacebook.svg' alt='socialiconfacebook' />
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src='/images/img_iconlinkedin.svg' alt='iconlinkedin' />
              </a>
            </li>
            <li>
              <a
              ...
              >
                <img src='/images/img_socialiconinstagram.svg' alt='socialiconinstagram' />
              </a>
            </li>
            <li>
              <a target='_blank' rel='noopener noreferrer' href='https://x.com/joinBlackJet'>
                <img src='/images/img_socialicontwitter.svg' alt='socialicontwitter' />
              </a>
            </li>
          </ul>
        </div>
