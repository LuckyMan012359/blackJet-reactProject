...
const PreorderPeriod = ({
  ...
  const memberPrevText = !onboardingForms.loginData.newUser ? (
    <p>
      <span className='second'>Congrats! Your order is complete</span>
    </p>
  ) : (
    <p>
      <span className='first'>Congrats!</span>
      <br /> <span className='second'>Your pre-order is complete</span>
    </p>
  );
      ...
      <form onSubmit={onSubmit}>
        <div className='onboardbg congrats-screen'>
          <div>
            ...
            {already || userData?.is_membership_purchased ? (
            ...
            <div
              className={`pre-order-hr ${onboardingForms?.isPreOrder ? 'preorder' : 'notpreorder'}`}
            ></div>
            {/* </div> */}
              ...
              <div className='congrats-wrap'>
                <div className='flex flex-col justify-center gap-[24px]  items-start'>
                  <div className='heading-16'>
                    {!already
                      ? 'Please answer few final questions to further enhance your Black Jet experience:'
                      : 'Lets make your Black Jet experience even better! Take a moment to answer a few questions:'}
                  </div>
